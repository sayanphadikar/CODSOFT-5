...
public class Address6 {
    ...
    private static void addContact(Scanner scanner) {
        ...
        // Input validation to check for required fields and correct formats
    ...
    private static void editContact(Scanner scanner) {
        ...
        for (Contact contact : contacts) {
            if (contact.getName().equalsIgnoreCase(searchName)) {
                ...
                // Input validation to check for correct format for phone number and email address
    ...
    private static boolean isValidEmailAddress(String emailAddress) {
        // Simple validation to check if the email address contains @ symbol
